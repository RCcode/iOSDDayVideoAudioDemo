...
//        BOOL isAudio = (connection == [_captureOutputAudio connectionWithMediaType:AVMediaTypeAudio]);
        ...
        BOOL wasReadyToRecord = (_flags.readyForVideo);
...
//        }
        ...
        BOOL isReadyToRecord = (_flags.readyForVideo);

        // calculate the length of the interruption
        if (_flags.interrupted) {
            _flags.interrupted = NO;

            CMTime time = _videoTimestamp;
...
//                CMTime offset = CMTimeSubtract(pTimestamp);
...
//            _audioTimestamp.flags = 0;
        ...
        } else if (isReadyToRecord && !_flags.interrupted) {
